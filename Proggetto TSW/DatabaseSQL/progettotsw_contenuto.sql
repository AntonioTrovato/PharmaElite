...
CREATE TABLE `contenuto` (
  ...
  CONSTRAINT `contenuto_ibfk_1` FOREIGN KEY (`EmailCliente`) REFERENCES `carrello` (`EmailCliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `contenuto_ibfk_2` FOREIGN KEY (`IDProdotto`) REFERENCES `prodotto` (`ID`)
