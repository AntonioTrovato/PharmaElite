...
CREATE TABLE `carrello` (
  ...
  CONSTRAINT `carrello_ibfk_1` FOREIGN KEY (`EmailCliente`) REFERENCES `cliente` (`IndirizzoEmail`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `carrello` VALUES ('gaetano@gmail.com',0.00),('giovanni@gmail.com',0.00),('luca@gmail.com',0.00),('raffaele@gmail.com',0.00),('salvatore@gmail.com',0.00);
